    ...
    <div className="fixed inset-0 z-[100] overflow-hidden">
      ...
      <div className="relative z-10 h-full flex flex-col pt-12">
        ...
        <div className="flex-1 overflow-hidden px-4 pb-4 pt-2">
          {/* Completion scene — show SimulationCompleteScreen in preview mode */}
          {sceneData.isCompletionScene ? (
            <div className="h-full rounded-2xl overflow-hidden bg-gradient-to-br from-slate-900/90 via-purple-900/60 to-slate-800/90 backdrop-blur-sm border border-white/10">
              <SimulationCompleteScreen isPreview={true} />
            </div>
            ...
            <div className="h-full grid grid-cols-1 xl:grid-cols-12 gap-2">
              ...
              {/* Main Content Area */}
              <div className={`flex flex-col space-y-1 overflow-hidden h-full min-h-0 ${sceneData.id === '9' ? 'xl:col-span-12' : 'xl:col-span-9'
                }`}>
                {/* Scene Header */}
                ...
                <div className="flex-1 overflow-hidden grid grid-cols-1 gap-2 min-h-0 max-h-full lg:grid-cols-5">
                  ...
                  {(sceneData.quiz || sceneData.actionPrompt) && (
                    <div className={`h-full min-h-0 max-h-full overflow-hidden ${sceneData.id === '9' ? 'lg:col-span-5' : 'lg:col-span-2'
                      }`}>
                      <QuizComponent
                        quiz={sceneData.quiz}

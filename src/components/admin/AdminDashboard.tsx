...
const ADMIN_TAB_VALID: AdminTab[] = ['instances', 'scenes', 'analytics', 'welcome', 'admins'];
...
const AdminDashboard: React.FC = () => {
  ...
  const [activeTab, _setActiveTab] = useState<AdminTab>(() => {
    try {
      ...
      if (stored && ADMIN_TAB_VALID.includes(stored as AdminTab)) return stored as AdminTab;
    } catch { /* ignore */ }
    return 'instances';
  });

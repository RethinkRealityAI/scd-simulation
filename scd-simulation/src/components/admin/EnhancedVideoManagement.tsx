...
const EnhancedVideoManagement: React.FC<EnhancedVideoManagementProps> = ({ onMessage, instanceId }) => {
  ...
  return (
    <div className="h-full flex flex-col gap-4">
      {/* Mode Indicator */}
      {!instanceId ? (
        <div className="bg-yellow-50 border-b border-yellow-200 px-4 py-2 flex items-center gap-3 flex-shrink-0">
          <Info className="w-4 h-4 text-yellow-600 flex-shrink-0" />
          <p className="text-xs text-yellow-800">
            <strong>Global Video Configuration:</strong> Videos uploaded here will be available to all instances that don't have their own specific videos.
          </p>
        </div>
      ) : (
        <div className="bg-blue-50 border-b border-blue-200 px-4 py-2 flex items-center gap-3 flex-shrink-0">
          ...
          <p className="text-xs text-blue-800">
            <strong>Instance Specific Configuration:</strong> Videos uploaded here will ONLY be visible in this instance, overriding global defaults.
          </p>
        </div>
      )}

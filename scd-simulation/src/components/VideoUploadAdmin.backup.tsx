...
const VideoUploadAdmin: React.FC = () => {
  ...
  // Analytics hook - will be used when Analytics tab is fully implemented
  ...
  return (
    <div className="h-screen flex flex-col bg-gradient-to-br from-blue-50 via-white to-purple-50 overflow-hidden">
      <div className="flex-1 flex flex-col container mx-auto px-4 py-6 max-w-7xl overflow-hidden">
        ...
        {/* Video Management Tab - Enhanced Split View */}
        {activeTab === 'videos' && (
        ...
        {/* Characters Management Tab - REMOVED */}
        {false && (
      ...
      {/* Scene Editor Modal - Now using modular component */}
        ...
        <SceneEditorModal
          ...
          onExport={async (sceneId) => {
            ...
            if (jsonData) {
              ...
              setMessage({ type: 'success', text: 'Scene configuration exported successfully!' });
            } else {

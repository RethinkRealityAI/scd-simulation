-- ============================================================================
-- MIGRATION 1: Scene Ordering System
-- File: supabase/migrations/20250126000000_scene_ordering_system.sql
-- 
...
SELECT 'Migration 1 completed successfully!' as status,
       (SELECT COUNT(*) FROM scene_order) as scene_count,
       (SELECT COUNT(*) FROM scene_management_settings) as settings_count;

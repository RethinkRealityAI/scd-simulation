...
import EnhancedWelcomeScreenEditor from './admin/EnhancedWelcomeScreenEditor';
...
const VideoUploadAdmin: React.FC = () => {
  ...
  return (
    <div className="h-screen flex flex-col bg-gradient-to-br from-blue-50 via-white to-purple-50 overflow-hidden">
      <div className="flex-1 flex flex-col container mx-auto px-4 max-w-7xl overflow-hidden">
        ...
        {/* Tab Content Area */}
        <div className="flex-1 overflow-hidden flex flex-col bg-white shadow-sm rounded-b-xl">
          {/* Message Display */}
          {message && (
            <div className={`mx-6 mt-4 p-3 rounded-lg flex items-center gap-3 shadow-sm border-l-4 flex-shrink-0 ${
          ...
          {activeTab === 'videos' && (
            <div className="h-full pb-8">
              <EnhancedVideoManagement onMessage={(msg) => {
                setMessage(msg);
                clearMessage();
              }} />
            </div>
        ...
        {activeTab === 'settings' && (
                ...
                <div className="bg-gray-50 rounded-lg p-6 border border-gray-200">
                  ...
                  {settingsChanged && (
                    <button
                      ...
                      className="mt-4 bg-gradient-to-r from-blue-600 to-purple-600 text-white px-4 py-2 rounded-lg flex items-center gap-2 hover:from-blue-700 hover:to-purple-700 transition-all shadow-sm"
                    >
          ...
          {/* Welcome Tab */}
          {activeTab === 'welcome' && (
            <EnhancedWelcomeScreenEditor onMessage={(msg) => {
              setMessage(msg);
              clearMessage();
            }} />
          )}

    ...
    <div className="h-full flex gap-4">
          ...
          <form onSubmit={handleUploadSubmit} className="p-4 space-y-3">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">
                    Scene
                    <span className="ml-2 text-xs text-gray-500">(✓ = has video)</span>
                  </label>
                  <select
                    value={selectedScene}
                    onChange={(e) => {
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full text-sm p-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 file:mr-3 file:py-1 file:px-3 file:rounded file:border-0 file:text-sm file:bg-blue-50 file:text-blue-700"
                    required
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full p-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 text-sm resize-none"
              ...
              <button
                ...
                className="w-full bg-gradient-to-r from-blue-600 to-purple-600 text-white py-2.5 rounded-lg hover:from-blue-700 hover:to-purple-700 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 font-medium text-sm transition-all"
              >
                {uploading ? (
                  <>
              ...
              <div className="space-y-3">
                {videos.map((video) => (
                  ...
                  >
                    ...
                    <h3 className="font-semibold text-gray-900 text-sm mb-1 line-clamp-1">{video.title}</h3>
      ...
      <div className="w-1/2 bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden flex flex-col">
        ...
        {previewUrl || selectedVideoForPreview ? (
          ...
          <div className="flex-1 flex items-center justify-center text-gray-400 p-5">
            <div className="text-center">
              <Video className="w-16 h-16 mx-auto mb-3 opacity-50" />
              <p className="text-sm font-medium text-gray-600 mb-2">No video for Scene {selectedScene}</p>

    ...
    <div className="flex flex-col h-full bg-white overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto p-3 space-y-1.5">
        ...
        >
          ...
          {layoutOpen ? <ChevronUp className="w-3.5 h-3.5 text-gray-400" /> : <ChevronDown className="w-3.5 h-3.5 text-gray-400" />}
        </button>
          ...
          return (
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-gray-400 leading-tight truncate mt-0.5">{def.description}</p>
              </div>
